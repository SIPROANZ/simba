           ...
           <table class="table resumen">
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td>{{ $ejecucione->unidadadministrativa->sector . '.'  .  $ejecucione->unidadadministrativa->programa . '.' . $ejecucione->unidadadministrativa->actividad . ' '. $ejecucione->unidadadministrativa->unidadejecutora }}</td>
