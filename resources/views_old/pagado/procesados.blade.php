                                ...
                                <tbody>
                                    @foreach ($pagados as $pagado)
                                        <tr>
                                            ...
                                            <td>
                                               <a class="btn btn-sm btn-primary " href="{{ route('pagados.pdf',$pagado->id) }}" data-toggle="tooltip" data-placement="top" title="Imprimir Pagado"><i class="fas fa-print"></i> Imprimir!</a>  
                                               <a class="btn btn-sm btn-success " href="{{ url('#') }}" data-toggle="tooltip" data-placement="top" title="Hacer una Transferencia"><i class="fas fa-check"></i> Transferir!</a>  
