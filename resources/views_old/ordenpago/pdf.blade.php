  ...
  <div class="container">
        ...
        <table class="table table-bordered table-sm resumen ">
               ...
               <tbody>
                ...
                <tr>
                <th colspan="4" style="text-align: center">AÑO DEL PRESUPUESTO {{ 2023 }}</th>
                </tr>
               </tbody>
                 ...
                 @foreach ($partidas as $valor)
                   <tr>
                    ...
                    ?>
                       ...
                       <td style="text-align: right">{{  number_format($valor->montocompromiso,2,',','.') }}</td>
