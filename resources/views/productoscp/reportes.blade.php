...
@section('title', 'PRODUCTOS VS CLASIFICADOR PRESUPUESTARIO')

@section('content_header')
    <h1>Reportes Productos vs Clasificador Presupuestario</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('productoscps.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
    ...
    <div class="box box-info padding-1">
        ...
        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('producto', $productos, 0, ['class' => 'form-control' . ($errors->has('producto') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un producto']) }}
                            ...
                            <div class="col-md-3">    
                                <div class="form-group">
                                    {{ Form::label('Clasificadores Presupuestarios') }}
