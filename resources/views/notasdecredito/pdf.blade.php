...
<body>
  <div class="container">
        ...
        <table class="table table-bordered table-sm resumen">
                    ...
                    <tr>
                      <th colspan="2"><strong>COMPROBANTE DE NOTA DE CREDITO:</strong></th>
                   ...
                   <tr>
                     <th colspan="4" class="text-center justify-content">MOTIVO DE LA NOTA DE CREDITO</th>
       ...
       <footer class="footer">
              ...
              <div class="pie text-left justify-left">ELABORADO POR EL USUARIO :  {{ $notasdecredito->usuario->name }}</div>
