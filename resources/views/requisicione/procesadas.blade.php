          ...
          <div class="col-md-12">
            <div class="card card-secondary collapsed-card">
              ...
              <div class="card-body">
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-block btn btn-outline-success btn-block submit-prevent-button show-alert-reversar-box" data-toggle="tooltip" data-placement="top" title="Reversar Requisicion"><i class="fa fa-fw fa-check"></i> Reversar</button>
                                                    </form>
                                                    @endcan
                                                          </div>
              <!-- /.card-body -->
