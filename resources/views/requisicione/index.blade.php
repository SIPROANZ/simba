                                        ...
                                        <td style="text-align: center">{{ $requisicione->usuario->name }}</td>
                                            <td>
                                                ...
                                                <form action="{{ route('requisiciones.anular',$requisicione->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-primary " href="{{ route('requisiciones.agregar',$requisicione->id) }}" data-toggle="tooltip" data-placement="top" title="Agregar Producto BOS"><i class="fas fa-outdent"></i></i> Agregar</a>
                                                 
                                                    <a class="btn btn-sm btn-success" href="{{ route('requisiciones.edit',$requisicione->id) }}" data-toggle="tooltip" data-placement="top" title="Editar Requisicion"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Anular Requisicion"><i class="fa fa-fw fa-trash"></i> Anular</button>
                                                </form>
