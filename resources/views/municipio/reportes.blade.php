    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('municipios.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
                        ...
                        <div class="col-md-4">    
                            <div class="form-group">
                                ...
                                {{ Form::text('municipio', '', ['class' => 'form-control' . ($errors->has('municipio') ? ' is-invalid' : ''), 'placeholder' => 'Ingrese municipio a buscar']) }}
                            ...
                            <div class="col-md-4">    
                                <div class="form-group">
                                    {{ Form::label('Estados') }}
                                    {{ Form::select('estado', $estados, 0, ['class' => 'form-control' . ($errors->has('estado') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
