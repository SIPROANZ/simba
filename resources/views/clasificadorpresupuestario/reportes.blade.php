...
@section('content_header')
    <h1>Reporte Clasificador Presupuestario</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('clasificadorpresupuestarios.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
                        ...
                        <div class="col-md-4">    
                            <div class="form-group">
                                ...
                                {{ Form::text('clasificador', '', ['class' => 'form-control' . ($errors->has('clasificador') ? ' is-invalid' : ''), 'placeholder' => 'Ingrese denominacion a buscar']) }}
