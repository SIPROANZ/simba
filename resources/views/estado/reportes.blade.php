    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('estados.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
                        ...
                        <div class="col-md-4">    
                            <div class="form-group">
                                {{ Form::label('Estado') }}
                                {{ Form::text('estado', '', ['class' => 'form-control' . ($errors->has('estado') ? ' is-invalid' : ''), 'placeholder' => 'Ingrese estado a buscar']) }}
