    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('users.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
                        ...
                        <div class="col-md-4">    
                            <div class="form-group">
                                {{ Form::label('Usuario') }}
                                {{ Form::text('usuario', '', ['class' => 'form-control' . ($errors->has('usuario') ? ' is-invalid' : ''), 'placeholder' => 'Ingrese usuario a buscar']) }}
