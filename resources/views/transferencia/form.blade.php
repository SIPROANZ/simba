<div class="box box-info padding-1">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            {{ Form::select('cuentasbancaria_id', $cuentasbancarias, $transferencia->cuentasbancaria_id, ['class' => 'form-control' . ($errors->has('cuentasbancaria_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione una cuenta bancaria']) }}
      ...
      <div class="col-md-4"> 
        <div class="form-group">
            ...
            {{ Form::text('beneficiario_name', $pagados->beneficiario->nombre,['class' => 'form-control', 'readonly' . ($errors->has('beneficiario_name') ? ' is-invalid' : ''), 'placeholder' => 'Beneficiario']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('pagado_id', $pagados->id, ['class' => 'form-control' . ($errors->has('pagado_id') ? ' is-invalid' : ''), 'placeholder' => 'Pagado Id']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::number('montoorden', $pagados->montoordenpago, ['class' => 'form-control', 'readonly' . ($errors->has('montoorden') ? ' is-invalid' : ''), 'placeholder' => 'Monto orden de pago']) }}
        ...
        <div class="col-md-4">
        <div class="form-group">
            {{ Form::label('Monto Por Pagar') }}
            {{ Form::number('montopagado', ($pagados->montoordenpago - $pagados->montopagado), ['class' => 'form-control', 'readonly' . ($errors->has('montopagado') ? ' is-invalid' : ''), 'placeholder' => 'monto pagado']) }}
        ...
        <div class="form-group">
            {{ Form::label('Fecha') }}
            {{ Form::date('created_at', $transferencia->created_at, ['class' => 'form-control' . ($errors->has('created_at') ? ' is-invalid' : ''), 'placeholder' => 'Fecha']) }}
