...
<body>
  <div class="container">
                ...
                <th class="text-center justify-content">   
                 <img src="{{ asset('images/logo.png') }}"> 
                    ...
                    <th class="text-center">
                        ...
                        <br>ADMINISTRACIÓN - NOTA DE DÉBITO<h2>
        ...
        <table class="table table-bordered table-sm resumen">
                    ...
                    <tr>
                      <th colspan="2"><strong>COMPROBANTE DE NOTA DE DÉBITO:</strong></th>
                   ...
                   <tr>
                     <th colspan="4" class="text-center justify-content">MOTIVO DE LA NOTA DE DÉBITO</th>
       ...
       <footer class="footer">
              ...
              <div class="pie text-left justify-left">ELABORADO POR:  {{ $notasdedebito->usuario->name }}</div>
