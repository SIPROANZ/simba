...
<body>
  <div class="container">
            ...
            <table class="table">
                ...
                <th class="text-center">
                    ...
                    <th class="text-center">
                        ...
                        <h2 class="titulo">FECHA: {{ $notasdedebito->created_at->toDateString() }}</h2>
        ...
        <table class="table table-bordered table-sm resumen">
                    ...
                    <tr>
                      <th colspan="2"><strong>COMPROBANTE DE NOTA DE DEBITO:</strong></th>
                      <td colspan="2" class="text-center justify-content"><strong>{{ $notasdedebito->id }}</strong></td>
                   </tr>
                   ...
                   <tr>
                     <th colspan="4" class="text-center justify-content">MOTIVO DE LA NOTA DE DEBITO</th>
               ...
               <tbody>
                <tr>
                    <td colspan="4">{{ $notasdedebito->descripcion }}</td>
                 </tr>
       ...
       <footer class="footer">
              <table class="table table-bordered">
                <thead >
                  <tr>
                    <th width="50%" class="firma">ELABORADO POR EL USUARIO :   el Usuario ::</th>
                    <th width="50%" class="firma">APROBADO POR:</th>
              ...
              <div class="pie text-left justify-left">ELABORADO POR EL USUARIO :  {{ $notasdedebito->usuario->name }}</div>
