            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Crear Notas de debito</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('notasdedebitos.store') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form">
                            @csrf
