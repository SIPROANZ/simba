    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('familias.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
    ...
    <div class="box box-info padding-1">
        ...
        <div class="row">
                            ...
                            <div class="form-group">
                                {{ Form::label('Segmento') }}
                                {{ Form::select('segmento', $segmentos, 0, ['class' => 'form-control' . ($errors->has('segmento') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un segmento']) }}
