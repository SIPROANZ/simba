<div class="box box-info padding-1">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            {{ Form::text('montocompromiso', $montototal, ['class' => 'form-control' . ($errors->has('montocompromiso') ? ' is-invalid' : ''), 'placeholder' => 'Monto compromiso']) }}
        ...
        <div class="form-group">
            {{ Form::label('Fecha') }}
            {{ Form::date('created_at', $compromiso->created_at, ['class' => 'form-control' . ($errors->has('created_at') ? ' is-invalid' : ''), 'placeholder' => 'Fecha']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('unidadadministrativa_id', $unidadadministrativa, ['class' => 'form-control' . ($errors->has('unidadadministrativa_id') ? ' is-invalid' : ''), 'placeholder' => 'Unidadadministrativa']) }}
            {!! $errors->first('unidadadministrativa_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        
        <div class="form-group">
            {{ Form::hidden('ncompromiso', $compromiso->ncompromiso, ['class' => 'form-control' . ($errors->has('ncompromiso') ? ' is-invalid' : ''), 'placeholder' => 'Ncompromiso']) }}
        ...
        <div class="form-group">
            {{ Form::hidden('status', $compromiso->status,  ['class' => 'form-control' . ($errors->has('status') ? ' is-invalid' : ''), 'placeholder' => 'Status']) }}
