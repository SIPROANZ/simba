    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('compromisos.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
