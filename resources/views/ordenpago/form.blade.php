    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                ...
                {{ Form::hidden('compromiso_id', $compromiso->id, ['class' => 'form-control', 'readonly' . ($errors->has('compromiso_id') ? ' is-invalid' : ''), 'placeholder' => '']) }}
                 {{ Form::label('N° Compromiso') }}
                {{ Form::text('ncompromiso', $compromiso->ncompromiso, ['class' => 'form-control', 'readonly' . ($errors->has('ncompromiso') ? ' is-invalid' : ''), 'placeholder' => '']) }}
