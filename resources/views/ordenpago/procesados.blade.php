                                        ...
                                        <tr>
                                           ...
                                           {{--
                                            ...
                                            <td>
                                                    ...
                                                    <a class="btn btn-sm btn-info " href="{{ route('ordenpagos.reversar',$ordenpago->id) }}" data-toggle="tooltip" data-placement="top" title="Reversar Orden de Pago"><i class="fas fa-check"></i> Reversar</a>
