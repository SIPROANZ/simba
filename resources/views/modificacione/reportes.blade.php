...
@section('title', 'Modificaciones Presupuestarias')

@section('content_header')
    <h1>Reporte de Modificaciones Presupuestarias</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('modificaciones.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-3">    
                <div class="form-group">
                    ...
                    {{ Form::select('tipo', $tiposmodificaciones, 0, ['class' => 'form-control' . ($errors->has('tipo') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
            ...
            <div class="form-group">
                ...
                {!! $errors->first('descripcion', '<div class="invalid-feedback">:message</div>') !!}
                    ...
                    <div class="col-md-3">    
                        <div class="form-group">
                            {{ Form::label('Estado de Modificacion') }}
