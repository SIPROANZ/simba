                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('precompromisos.aprobar',$precompromiso->id) }}" method="POST" class="submit-prevent-form">
                                                   ...
                                                   @csrf
                                                    ...
                                                    <button type="submit" class="btn btn-outline-dark btn-sm float-right" data-toggle="tooltip" data-placement="top" title="Aprobar Precompromiso"><i class="fas fa-check-double"></i> Aprobar</button>
                                                </form> 
