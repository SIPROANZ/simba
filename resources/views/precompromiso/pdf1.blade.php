<html>
 ...
 <h2>
    ...
    <footer>
              ...
              <div class="pie text-left justify-left">ELABORADO POR EL USUARIO :   el Usuario ::</div>
    </footer>
    </body>
    </html>