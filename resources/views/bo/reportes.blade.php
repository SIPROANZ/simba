    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('bos.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
            ...
            <div class="col-md-4">    
                ...
                <div class="col-md-4">    
                            <div class="form-group">
                                ...
                                {{ Form::select('unidad', $unidades, 0, ['class' => 'form-control' . ($errors->has('unidad') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione una unidad']) }}
                ...
                <div class="col-md-4">    
                    <div class="form-group">
                        {{ Form::label('Tipo BOS') }}
                        {{ Form::select('tipo', $tipos, 0, ['class' => 'form-control' . ($errors->has('tipo') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un tipo']) }}
