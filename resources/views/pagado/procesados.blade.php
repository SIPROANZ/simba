          ...
          <div class="col-md-12">
            <div class="card card-secondary collapsed-card">
              ...
              <div class="card-body">
                                               ...
                                               <a class="btn btn-sm btn-block btn btn-outline-success btn-blockbtn-block " href="{{ route('pagados.agregartransferencia',$pagado->id)}}" data-toggle="tooltip" data-placement="top" title="Hacer una Transferencia"><i class="fas fa-check"></i> Transferir</a>  
