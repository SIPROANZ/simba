...
@section('content_header')
    <h1>Reportes Objetivos Estrategicos</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('objetivosestrategicos.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
                        ...
                        <div class="col-md-4">    
                            ...
                            <div class="col-md-4">    
                                <div class="form-group">
                                    ...
                                    {{ Form::select('nacional', $nacionales, 0, ['class' => 'form-control' . ($errors->has('nacional') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
                                    {!! $errors->first('nacional ', '<div class="invalid-feedback">:message</div>') !!}
                                </div>
                                </div>
