    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('productos.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
    ...
    <div class="box box-info padding-1">
        ...
        <div class="row">
                            ...
                            <div class="form-group">
                                {{ Form::label('Clases') }}
                                {{ Form::select('clase', $clases, 0, ['class' => 'form-control' . ($errors->has('clase') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione una clase']) }}
