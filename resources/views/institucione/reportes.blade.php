    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('instituciones.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
                        ...
                        <div class="col-md-4">    
                            <div class="form-group">
                                ...
                                {{ Form::text('institucion', '', ['class' => 'form-control' . ($errors->has('institucion') ? ' is-invalid' : ''), 'placeholder' => 'Ingrese nombre institucion']) }}
                            ...
                            <div class="col-md-4">    
                                <div class="form-group">
                                    ...
                                    {{ Form::select('municipio', $municipios, 0, ['class' => 'form-control' . ($errors->has('municipio') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
