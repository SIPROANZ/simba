...
@section('title', 'Ajustes de Compromisos')

@section('content_header')
    <h1>Reportes Ajustes de Compromisos</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('ajustescompromisos.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
    ...
    <div class="box box-info padding-1">
        ...
        <div class="row">
                        ...
                        <div class="form-group">
                            {{ Form::label('Tipo') }}
                            {{ Form::select('tipo', ['1'  => 'AUMENTO', '2'  => 'DISMINUYE'], 0, ['class' => 'form-control' . ($errors->has('tipo') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un tipo']) }}
