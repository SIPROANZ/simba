    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('comprobantesretenciones.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-3">    
                <div class="form-group">
                    ...
                    {{ Form::select('retencion_id', $retenciones, 0, ['class' => 'form-control' . ($errors->has('retencion_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione uno']) }}
                    ...
                    <div class="col-md-3">    
                        <div class="form-group">
                            {{ Form::label('Estatus') }}
                            {{ Form::select('status', ['EP'  => 'EN PROCESO', 'PR'  => 'PROCESADO', 'AP'  => 'ENTREGADO', 'AN'  => 'ANULADO' ], 0, ['class' => 'form-control' . ($errors->has('status') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un estado']) }}
