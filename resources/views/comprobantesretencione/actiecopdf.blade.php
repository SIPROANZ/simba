...
<head>
    ...
    <title> COMPROBANTE DE RETENCIÓN SOBRE ACTIVIDADES ECONOMICAS</title>
       ...
       <header>
                ...
                <div class="row text-center justify-content">
                    ...
                    <div class="col-md-12">
                            <div class="text-center justify-content">
                                    ...
                                    G-20016716-5<br>
                                    ADMINISTRACIÓN<br>
                                    <h3 class="subtitulo">COMPROBANTE DE RETENCIÓN SOBRE ACTIVIDADES ECONOMICAS </h3>
        ...
        <main>
          ...
          <table class="table table-bordered table-sm resumen-amd" >
            <thead>
                <tr>
                    <th width="20%">NOMBRE O RAZON SOCIAL DEL
                      SUJETO RETENIDO:  </th>
                    ...
                    <td width="15%" class="encabezado text-left justify-content"><br><b>{{ $comprobantesretencione->ncomprobante }}</b></td>
                </tr>
            </thead>
           <tbody>
                <tr>
                 ...
                 <tr>
                      <th>DIRECCION: </th>
                     <td  class="encabezado text-left justify-content" colspan="3">{{ $comprobantesretencione->ordenpago->beneficiario->direccion }} </td>
         ...
         <table class="table table-bordered table-sm resumen-amd" >
            <thead>
                <tr>
                    ...
                    <th width="25%" class="encabezado text-center justify-content">N° ORDEN DE PAGO </th>
                    <th width="25%" class="encabezado text-center justify-content">DOCUMENTO </th>
                    <th width="25%" class="encabezado text-center justify-content">N° DOCUMENTO</th>
                    <th width="25%" class="encabezado text-center justify-content">MONTO</th>
                    <th width="25%" class="encabezado text-center justify-content">ALICUOTA</th>
                    <th width="25%" class="encabezado text-center justify-content"> IMPUESTO
                        RETENIDO</th>
           ...
           <tbody>
            ...
            <tr>
              ...
              <td  class="encabezado text-center justify-content">{{ $comprobantesretencione->ordenpago->nordenpago }}</td>
              <td  class="encabezado text-center justify-content">ORDEN DE PAGO</td>
              <td  class="encabezado text-center justify-content">{{ $factura->numero_factura }}</td>
              <td  class="encabezado text-right justify-content">{{ number_format($factura->montobase,2,',','.') }}</td>
              ...
              <td  class="encabezado text-right justify-content">{{ number_format(($factura->montobase * ($comprobantesretencione->detretencione->retencione->porcentaje / 100)),2,',','.') }}</td>
