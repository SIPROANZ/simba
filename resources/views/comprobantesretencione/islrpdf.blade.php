       ...
       <tbody>
        @foreach ($facturas as $item)
            ...
            <tr>
                ...
                <td  class="encabezado text-right justify-content">{{ number_format(($item->montobase * ($comprobantesretencione->detretencione->retencione->porcentaje / 100)),2,',','.') }}</td>
                <td  class="encabezado text-right justify-content">{{ number_format(0,2,',','.') }}</td>
