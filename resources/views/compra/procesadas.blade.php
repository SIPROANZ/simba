                                    ...
                                    @foreach ($compras as $compra)
                                        ...
                                        <td>{{ $compra->numordencompra }}</td>
                                            ...
                                            <form action="{{ route('compras.modificar',$compra->id) }}" method="POST">
                                                @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Modificar Compra, esto afecta la ejecucion, tener mucho cuidado."><i class="fa fa-fw fa-check"></i> Modificar</button>
                                            </form>
