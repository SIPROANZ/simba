...
@section('content_header')
    <h1>Ordenes de Compras Procesadas</h1>
@stop
@section('content')
<br>
            ...
            <div class="card card-secondary collapsed-card">
              ...
              <div class="card-body">
                                            ...
                                            <form action="{{ route('compras.modificar',$compra->id) }}" method="POST" class="submit-prevent-form">
                                                @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="btn btn-sm btn-block btn btn-outline-dark btn-block submit-prevent-button show-alert-reversar-box" data-toggle="tooltip" data-placement="top" title="Modificar Compra, esto afecta la ejecucion, tener mucho cuidado."><i class="fa fa-fw fa-check"></i> Reversar</button>
                                            </form>
