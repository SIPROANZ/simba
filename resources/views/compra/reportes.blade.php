...
@section('content_header')
    <h1>Reportes Ordenes de Compras y Servicios</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('compras.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
    ...
    <div class="box box-info padding-1">
        ...
        <div class="row">
                        ...
                        <div class="col-md-3">    
                            <div class="form-group">
                                {{ Form::label('Tipo') }}
                                {{ Form::select('tipo_id', $tipos, 0, ['class' => 'form-control' . ($errors->has('tipo_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un tipo']) }}
