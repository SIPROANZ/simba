...
@section('content_header')
    <h1>Reportes de Transferencias entre cuentas</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('transferenciaentrecuentas.reporte_pdf') }}"  role="form" enctype="multipart/form-data" class="submit-prevent-form" target="_black">
    @csrf
        ...
        <div class="row">
                ...
                <div class="col-md-3">    
                    ...
                    <div class="col-md-3">    
                        ...
                        <div class="col-md-3">    
                            <div class="form-group">
                                {{ Form::label('Bancos Destino') }}
                                {{ Form::select('banco_dest', $bancosdestino, 0, ['class' => 'form-control' . ($errors->has('banco_dest') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un banco']) }}
                                {!! $errors->first('banco_dest', '<div class="invalid-feedback">:message</div>') !!}
                            </div>
                            </div>
                            ...
                            <div class="col-md-3">    
                                <div class="form-group">
                                    ...
                                    {{ Form::select('cuenta_dest', $cuentasdestino, 0, ['class' => 'form-control' . ($errors->has('cuenta_dest') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione una cuenta']) }}
                                    {!! $errors->first('cuenta_dest', '<div class="invalid-feedback">:message</div>') !!}
                                </div>
                                </div>
