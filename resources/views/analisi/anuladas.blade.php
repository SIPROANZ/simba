                                ...
                                <tbody>
                                    @foreach ($analisis as $analisi)
                                        <tr>
                                            ...
                                            <a class="btn btn-sm btn-block btn btn-outline-dark btn-block" href="{{ route('analisis.pdf',$analisi->id) }}" data-toggle="tooltip" data-placement="top" title="Imprimir Analisis"><i class="fas fa-print"></i> Imprimir</a>
