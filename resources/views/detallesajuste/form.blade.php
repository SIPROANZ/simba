<div class="box box-info padding-1">
    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
            {{ Form::label('ajustes') }}
            {{ Form::text('ajustes_id', session('ajustecompromiso'), ['class' => 'form-control' . ($errors->has('ajustes_id') ? ' is-invalid' : ''), 'readonly', 'placeholder' => 'Ajustes Id']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('unidadadministrativa_id', $detallesajuste->unidadadministrativa_id, ['class' => 'form-control' . ($errors->has('unidadadministrativa_id') ? ' is-invalid' : ''), 'readonly',  'placeholder' => 'Unidadadministrativa Id']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('ejecucion_id', $detallesajuste->ejecucion_id, ['class' => 'form-control' . ($errors->has('ejecucion_id') ? ' is-invalid' : ''), 'readonly', 'placeholder' => 'Ejecucion Id']) }}
