       ...
       <header>
                ...
                <div class="row text-center justify-content">
                    ...
                    <div class="col-md-12">  
                            <div class="text-center justify-content">
                                    ...
                                    GOBERNACION DE ANZOATEGUI </h2>
                                    <h2 class="titulo2  " >DIRECCION DE ADMINISTRACIÓN
        ...
        <main>
            <table class="table table-bordered resumen table-sm">
                ...
                <tbody>
                    <tr>
                        <td rowspan="2">UNIDAD SOLICITANTE: Dirección De Automatización, Informática Y Telecomunicaciones (ait)</td>
                        <td>FECHA DE ANALISIS</td>

                        <td colspan="2">REQUISISCIÓN</td>
                    
                    </tr>
                   
                    <tr>
                    <td>07/09/2022</td>  
                    <td>FECHA 29/08/2022</td>
                    <td>N° 417</td>   
                    </tr>
                </tbody>
            </table>
...
Anzoategui, C.a</td>  
                    ...
                    <tr>
                        <td>1</td>
                        <td>COMPUTADORA PORTATIL (LAPTOP) MARCA LENOVO 
                          , PROCESADOR CORE I3, 8GB DE RAM, 256 GB DE SSD,
                           11AVA GENERACION</td>
                        <td>1,00</td>
                        <td>6.766,00</td>
                        <td>6.766,00</td>
            ...
            <table class="table table-bordered resumen table-sm">
                ...
                <tbody>
                    <tr>
                        <td>NOMBRE: Tecnologia Anzoategui, C.a</td>
                        <td>RIF: J-00202021-6</td>
                        <td>TELEFONOS: 04248686349</td>
                    </tr>
                    <tr>
                        <td colspan="3">DIRECCIÓN: Mi Direccion en el Estado Anzoátegui</td>
                    </tr>
                </tbody>
           </table>
           <table class="table table-bordered resumen table-sm">
