            ...
            <div class="card card-secondary collapsed-card">
              ...
              <div class="card-body">
                                                <form action="{{ route('requisiciones.anular',$requisicione->id) }}" method="POST" class="submit-prevent-form">
                                                    ...
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="btn btn-outline-danger btn-sm btn-block submit-prevent-button" data-toggle="tooltip" data-placement="top" title="Anular Requisicion"><i class="fa fa-fw fa-trash"></i> Anular</button>
                                                </form>
                                                ...
                                                <form action="{{ route('requisiciones.aprobar',$requisicione->id) }}" method="POST" class="submit-prevent-form">
                                                   ...
                                                   @csrf
                                                    @method('PATCH')
                                                <button type="submit" class="btn btn-sm btn-block btn btn-outline-dark btn-block" data-toggle="tooltip" data-placement="top" title="Aprobar Requisicion"><i class="fas fa-check-double"></i> Aprobar</button>
                                                </form>
