                        ...
                        <div class="col-md-3">    
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{ Form::date('fecha_inicio', $fecha_actual, ['class' => 'form-control' . ($errors->has('fecha_inicio') ? ' is-invalid' : ''), 'placeholder' => 'Fecha']) }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::date('fecha_fin', $fecha_actual, ['class' => 'form-control' . ($errors->has('fecha_fin') ? ' is-invalid' : ''), 'placeholder' => 'Fecha']) }}
