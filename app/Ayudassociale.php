...
class Ayudassociale extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['documento','montototal','concepto','unidadadministrativa_id','tipocompromiso_id','beneficiario_id', 'status','fechaanulacion','created_at', 'usuario_id'];
